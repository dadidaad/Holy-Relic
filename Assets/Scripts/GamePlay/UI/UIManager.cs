...
public class UIManager : MonoBehaviour
{
        ...
        if (paused == false)
        {
            ...
            if (Input.GetMouseButtonDown(0) == true)
            {
                ...
                if (results.Count > 0) // UI components on pointer
                {
                    ...
                    EventManager.InvokeEvent("UserUiClick", hittedObj, null);
                }
                else // No UI components on pointer
                {
                    ...
                    EventManager.InvokeEvent("UserClick", hittedObj, null);
                }
    ...
    {
        EventManager.InvokeEvent("SceneQuit", null, null);
    ...
    private void PauseGame(bool pause)
    {
        ...
        EventManager.InvokeEvent("GamePaused", null, pause.ToString());
    }
